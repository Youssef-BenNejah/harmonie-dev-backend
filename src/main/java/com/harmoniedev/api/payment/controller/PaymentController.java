...
public class PaymentController {
	...
	public ResponseEntity<ApiResponse<List<PaymentResponse>>> list(
		...
		List<PaymentResponse> payments = invoiceId != null ? service.listForInvoice(invoiceId) : service.list();
		return ResponseEntity.ok(ApiResponse.success("Payments", payments));
	}

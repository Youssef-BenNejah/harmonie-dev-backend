...
import com.harmoniedev.api.expense.service.DepenseCategoryService;
...
@RestController
@RequestMapping("/api/v1/depense-categories")
public class DepenseCategoryController {
	private final DepenseCategoryService service;

	public DepenseCategoryController(DepenseCategoryService service) {
		this.service = service;
	}

	@PostMapping
	public ResponseEntity<ApiResponse<DepenseCategoryResponse>> create(
			@Valid @RequestBody DepenseCategoryRequest request, Authentication authentication) {
	...
	@GetMapping
	public ResponseEntity<ApiResponse<List<DepenseCategoryResponse>>> list() {
		return ResponseEntity.ok(ApiResponse.success("Categories", service.list()));
	}

	@PutMapping("/{id}")
	public ResponseEntity<ApiResponse<DepenseCategoryResponse>> update(
			@PathVariable String id, @Valid @RequestBody DepenseCategoryRequest request) {
